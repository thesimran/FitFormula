...
public class MyWorkout extends ListActivity {
	...
	public void makeWorkoutSchedule (int myYear, int myMonth, int myDay){
		...
		*/
    	...
    	int achieveNum=3;  //update achievement db to unlock achievement 3, (Got a workout schedule)
...
/*		Calendar cal = Calendar.getInstance();              
	...
	public void initiateWorkoutsInDB() {
		...
		// Achievements
		db.delete(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, null);
		values.put(DatabaseHelper.achievementnumber, 0);
		values.put(DatabaseHelper.achievementdescription, "Entered biometrics");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 1);
		values.put(DatabaseHelper.achievementdescription, "Got a resting heart rate");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 2);
		values.put(DatabaseHelper.achievementdescription, "Finished the step test");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 3);
		values.put(DatabaseHelper.achievementdescription, "Got a workout schedule");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 4);
		values.put(DatabaseHelper.achievementdescription, "Completed 1 workout session");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 5);
		values.put(DatabaseHelper.achievementdescription, "Completed 10 workout sessions");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 6);
		values.put(DatabaseHelper.achievementdescription, "Completed 100 workout sessions");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 7);
		values.put(DatabaseHelper.achievementdescription, "Completed 1000 workout sessions");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 8);
		values.put(DatabaseHelper.achievementdescription, "Completed 1 workout cycle");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 9);
		values.put(DatabaseHelper.achievementdescription, "Completed 10 workout cycles");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 10);
		values.put(DatabaseHelper.achievementdescription, "Completed 100 workout cycles");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 11);
		values.put(DatabaseHelper.achievementdescription, "Advanced a workout level");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 12);
		values.put(DatabaseHelper.achievementdescription, "Reached the maximum workout level (level 5)");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 13);
		values.put(DatabaseHelper.achievementdescription, "Completed a workout program");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 14);
		values.put(DatabaseHelper.achievementdescription, "Reduced cardiovascular risk by 1%");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 15);
		values.put(DatabaseHelper.achievementdescription, "Reduced cardiovascular risk by 2%");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 16);
		values.put(DatabaseHelper.achievementdescription, "Reduced cardiovascular risk by 5%");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 17);
		values.put(DatabaseHelper.achievementdescription, "Lost 1 kg");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 18);
		values.put(DatabaseHelper.achievementdescription, "Lost 2 kg");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 19);
		values.put(DatabaseHelper.achievementdescription, "Lost 5 kg");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 20);
		values.put(DatabaseHelper.achievementdescription, "Increased aerobic fitness & VO2 max by 0.5 ml/kg/min");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 21);
		values.put(DatabaseHelper.achievementdescription, "Increased aerobic fitness & VO2 max by 1 ml/kg/min");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 22);
		values.put(DatabaseHelper.achievementdescription, "Increased aerobic fitness & VO2 max by 2 ml/kg/min");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 23);
		values.put(DatabaseHelper.achievementdescription, "Worked out for 100 minutes");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 24);
		values.put(DatabaseHelper.achievementdescription, "Worked out for 500 minutes");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 25);
		values.put(DatabaseHelper.achievementdescription, "Worked out for 1000 minutes");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 26);
		values.put(DatabaseHelper.achievementdescription, "Worked out for 5000 minutes");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 27);
		values.put(DatabaseHelper.achievementdescription, "Reduced resting heart rate by 1");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 28);
		values.put(DatabaseHelper.achievementdescription, "Reduced resting heart rate by 2");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.put(DatabaseHelper.achievementnumber, 29);
		values.put(DatabaseHelper.achievementdescription, "Reduced resting heart rate by 5");
		values.put(DatabaseHelper.achieved, false);
		db.insert(DatabaseHelper.ACHIEVEMENTS_TABLE_NAME, null, values);
		values.clear();
